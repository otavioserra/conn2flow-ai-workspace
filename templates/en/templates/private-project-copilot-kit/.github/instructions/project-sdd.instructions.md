...
description: 'Use when editing specs, batches, reviews, change requests, decisions, or validation in local project scopes inside Conn2Flow private projects.'
applyTo: 'project/**/*.md'
---
...
- Treat `antigo/` as history, not as the current source of truth.
- When working in those scopes, use the skill [project-sdd-context](../skills/project-sdd-context/SKILL.md).
