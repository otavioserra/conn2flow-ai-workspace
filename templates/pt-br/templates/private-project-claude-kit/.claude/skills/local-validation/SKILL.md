...
4. Depois da edição, valide primeiro o slice tocado e só depois amplie o escopo.
5. Use logs e consultas pontuais antes de partir para verificacoes maiores.
