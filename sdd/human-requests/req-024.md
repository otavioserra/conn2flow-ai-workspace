...
- [x] Atualizar `c2f-html-css-pages-and-components/SKILL.md` em todos os templates e masters com a regra de 2 níveis do `HTML_SANITIZE`.
- [x] Atualizar `c2f-agent-visual-inspection/SKILL.md` documentando a preservação do DOM em sessões autenticadas.
- [x] Atualizar `c2f-environment-configuration/SKILL.md` com a governança da flag `HTML_SANITIZE`.
