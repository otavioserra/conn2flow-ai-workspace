...
- [x] Atualizar a skill `c2f-javascript-ajax/SKILL.md` em todos os 6 templates de kits em `templates/pt-br/`.
- [x] Atualizar a skill `c2f-javascript-ajax/SKILL.md` em todos os 6 templates de kits em `templates/en/`.
- [x] Atualizar a skill local `.claude/skills/c2f-javascript-ajax/SKILL.md` e `.gemini/skills/c2f-javascript-ajax/SKILL.md`.
- [x] Atualizar `docs/pt-br/CATALOGO-DE-SKILLS.md` e `docs/en/SKILLS-CATALOG.md`.
