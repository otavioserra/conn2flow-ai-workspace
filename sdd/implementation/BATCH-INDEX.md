...
| **BATCH-002** | in-progress | Otimização de Contexto e Governança de Arquivamento | sdd/validation/VALIDATION-CHECKLIST.md#batch-002 | Estrutura `archive/`, limite de 10 itens correntes e tabelas resumidas de histórico. |
