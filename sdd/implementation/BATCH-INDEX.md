...
| **BATCH-003** | in-progress | Migração Histórica e Saneamento de Legado no Conn2flow-site | sdd/validation/VALIDATION-CHECKLIST.md#batch-003 | Migrar e cindir os históricos de arquivos, multiusuarios e host-manager, mover docs de paypal/documentacoes, deletar presentation e project. |
