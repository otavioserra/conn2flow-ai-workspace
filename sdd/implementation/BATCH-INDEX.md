...
| **BATCH-003** | ready-for-intake | Monitor de Requisições Híbrido (Local File Watcher) | `scripts/sdd-watcher.ps1` / `.sh` | Monitorar CURRENT.md e notificar o sistema local quando uma nova demanda for publicada pelo Arquiteto. |
