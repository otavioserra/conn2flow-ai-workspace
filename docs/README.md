# 📚 Central de Documentação Técnica — Conn2Flow AI Workspace

Bem-vindo à documentação aprofundada da infraestrutura, governança e metodologia de agentes de Inteligência Artificial do Conn2Flow.

---

## 🧭 Índice de Documentações

1. **[Arquitetura de Agente Duplo (Double Agent SDD)](ARQUITETURA-AGENTE-DUPLO.md)**:
...
2. **[Catálogo Completo de Skills](CATALOGO-DE-SKILLS.md)**:
...
3. **[Roteiro de Evolução Futura & Backlog Estratégico](ROTEIRO-EVOLUCAO-FUTURA.md)**:
