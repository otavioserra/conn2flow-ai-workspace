...
export class CustomActionsManager {
  ...
  public static getManifestPath(): string | undefined {
  ...
  public static getActionsManifest(): CustomActionsManifest | undefined {
  ...
  public static setupWatcher(onChanged: () => void): vscode.Disposable {
    if (this.watcher) {
    ...
    const pattern = new vscode.RelativePattern(
      ...
      '{.c2f/actions.json,.conn2flow/actions.json,c2f.actions.json}'
    );
  ...
  public static async initSampleManifest(onCreated?: () => void): Promise<void> {
    ...
    const sample: CustomActionsManifest = {
